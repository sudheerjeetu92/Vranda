...
const selectedProduct = {
  ...
  originalPrice: 150.0,
  description:
    "A high-quality leather jacket that combines both style and comfort. Perfect for all seasons.",
  brand: "UrbanWear",
...
const ProductDetails = () => {
  ...
  const handleAddToCart = () => {
    ...
    setTimeout(() => {
      toast.error("Product added to cart", { duration: 1000 });
    ...
    <div className="p-6">
      <div className="max-w-6xl mx-auto bg-white p-8 rounded-lg">
        ...
        <div className="mt-20">
          ...
          <ProductGrid products={similarProcts} />
        </div>
      </div>
    </div>
  );
